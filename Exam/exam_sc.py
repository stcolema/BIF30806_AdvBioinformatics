...
def call_files():
    ...
    try:
        ...
        if output_to_file.upper() in 'YES':
            output_to_file = True
            output_file_aug_to_fasta = input('Please input output file name '
    ...
    try:
        ...
        if output_to_file:
            output_file_proteins_to_db = input('Please input output file name'
                                               + 'for blast database: ')
        else:
    ...
    try:
        ...
        if output_to_file:
            blastp_output = input('Please input output file name'
                                  + 'for blastp: ')
        else:
            blastp_output = None
